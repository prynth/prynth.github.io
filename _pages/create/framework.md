...
- 8-channel analog multiplexers compatible with the 4051 pin scheme (up to 8, depending on the required number of analog input channels, tested with Max4617CPE) ([arduino](http://playground.arduino.cc/Learning/4051))
